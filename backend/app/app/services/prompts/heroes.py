...
Summary: The youngest of six mermaid princesses, the little mermaid is not only the most beautiful, but the most introspective and thoughtful. Since their mother has died, the mermaids are raised by their grandma. The youngest asks for all the information she can get about the world above the sea. Each princess has her own sea garden, which she can decorate as she chooses. The youngest arranges everything in the shape of the sun, and places in it the statue of a handsome prince from a sunken ship.
...
She agrees, and though each step on land is like walking on knives, she manages to join the court of the prince. Despite her muteness, the prince treats her kindly. One day the princess who found him on the shore arrives and the prince, recognizing her as the one who saved him from drowning, vows his love for her. Together with the little mermaid, they sail away to their wedding. Her sisters bring the little mermaid a knife bought from the sea witch with their hair, instructing her to murder the prince with it so she can rejoin them in the sea. But the little mermaid is unable to do this. Brokenhearted, she kisses the happy couple and dives at sunrise to die in the waves of the sea. Instead, she finds herself lifted out of the water by the daughters of the air, who teach her how to bless children and thereby obtain an eternal soul.''',
    'HEROES': '''
<character> Mermaid <description> Mermaid is a beautiful girl, the daughter of an underwater king. A little underwater inhabitant, inquisitive and smart little mermaid. With a pure heart and an open soul. Light as sea foam. <stop>
<character> Prince <description> Prince is a young ruler, a handsome young man, beloved of the Little Mermaid. A naive young man is easily deceived, but sincere and honest. <stop>
<character> Sea King <description> Sea King is a lord of the underwater world, the father of the Little Mermaid. Lord of the sea, father of many children. He has long since become a widower, and his mother manages the estate. Terrible in moments of anger, but generous and fair. <stop>
<character> Grandma <description> Grandma is the Little Mermaid's grandmother, a wise old woman. Assistant
...
<character> Witch <description> Witch us a sea evil sorceress. Deceives and misleads people and animals. It has great power, but uses it for its own selfish purposes. <stop>
'''
}
